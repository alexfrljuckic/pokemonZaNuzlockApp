...
export const KANTO_MAP: GameMap = {
  ...
  nodes: [
    ...
    { id: 'viridian-forest', x: 375, y: 443, w: 110, h: 105, kind: 'forest' },
    { id: 'route-3', x: 756, y: 298, w: 112, h: 90, kind: 'route' },
    ...
    { id: 'route-16', x: 838, y: 456, w: 112, h: 90, kind: 'route' },
    { id: 'route-17', x: 729, y: 723, w: 90, h: 112, kind: 'route' },
    { id: 'route-18', x: 886, y: 1157, w: 112, h: 90, kind: 'route' },
    ...
    { id: 'route-22', x: 352, y: 665, w: 112, h: 90, kind: 'route' },
    ...
    { id: 'pewter-city', x: 593, y: 280, w: 110, h: 95, kind: 'city' },
    ...
    { id: 'cinnabar-island', x: 516, y: 1300, w: 110, h: 92, kind: 'city' },
